...
Prueba tecnica 'MercadoLibre' - xmen proyecto api rest

# Configuracion para base de datos

1. Cambiar la conexion de la base de datos en el archivo: appsettings.dev.json
2. Descomentar linea 98 del archivo xmen.infraestructure\Context\CoreContext.cs y cambiar la cadena de conexion
3. Comentar la linea 99 de archivo xmen.infraestructure\Context\CoreContext.cs
4. Crear una BD en Sql server con el mismo nombre que se creo en la cadena de conexion.


# Correr migracion

1. Abrir "package manager console" 
2. seleccionar el proyecto "03.infraestructure\xmen.infraestructure"
correr el comando "update-database -target 'nombre migracion'"
